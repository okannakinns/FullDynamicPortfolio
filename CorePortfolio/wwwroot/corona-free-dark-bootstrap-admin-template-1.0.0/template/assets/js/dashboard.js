  ...
  $(function() {
    ...
    if($('#audience-map').length) {
      ...
      if ($("#transaction-history").length) {
          ...
          var status2 = $("#status3").text();
          var status3 = $("#status2").text();
          var totalStatus = $("#status-total").text();
          var areaData = {
              labels: ["Tamamlanan", "Planlanan", "Devam Eden"],
              datasets: [{
                  data: [status1, status2, status3],
                  backgroundColor: [
                      "#00d25b", "#ff0000", "#ffab00"
                  ]
              }
              ]
          };
